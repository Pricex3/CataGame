...
#CE QU'IL FAUT FAIRE
#faire les collisions et le systeme de vie
#faire un bouton quitter permet de quitter le jeu. Ce bouton sera dans l'espace graphique.
...
class Catapulte:
	...
	def check_collision(self):
		...
		if catapulte2.posx -20 < catapulte1.posx_proj < catapulte2.posx + catapulte2.largeur_img + 20 and catapulte2.posy - 20 < catapulte1.posy_proj < catapulte2.posy + catapulte2.hauteur_img + 20:
			print("collide")
